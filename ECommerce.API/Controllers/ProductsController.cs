...
namespace ECommerce.API.Controllers
{
    ...
    public class ProductsController : ApiBaseController // edit not to inherit from  ControllerBase become  ApiBaseController
    {
        ...
        [HttpGet]
        public async Task<ActionResult<IReadOnlyList<ProductDto>>>GetAllProducts( [FromQuery] ProductQueryParams queryParams ,CancellationToken ct = default)//int? brandId ,int? typeId the pramters too match with serarch , oreder and paganation so go to queryparams
        {
